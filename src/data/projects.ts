...
const projects: Project[] = [
  {
    ...
    repoUrl: '',
    tags: ['React', 'Vite', 'Node.js', 'MongoDB', 'SaaS', 'Booking'],
  ...
  },
  {
    ...
    title: 'Subcreation',
    description:
      'A worldbuilding tool for fiction authors, game masters, and independent creators. Organise lore, connect entities with a live relationship graph, pin locations on nested maps, and write with your world open beside you.',
    image: '/images/subcreation/1.png',
    imageBgHex: '#0D182A',
    liveUrl: 'https://subcreation.app/',
    repoUrl: '',
    tags: ['Next.js', 'React', 'TypeScript', 'SaaS'],
    category: ['Full-Stack'],
    accentColor: 'violet',
    accentHex: '#EEEDE6',
    accentHexLight: '#0D182A',
    featured: true,
    stats: [],
    gallery: [],
    techBrief:
      'Next.js 15 App Router with React 19 and TypeScript 5. Tailwind CSS v4 (CSS-first config) with shadcn/ui component primitives (Radix UI). Neon serverless Postgres backed by Drizzle ORM; Better Auth v1 for authentication. Tiptap v3 powers the rich-text writing workspace with a custom wikilink suggestion extension. React Flow (XYFlow) with Dagre layout renders the interactive entity relationship graph. Vercel Blob for file storage, Resend for email, Zustand v5 for UI state, JSZip for Markdown export.',
    caseStudy: {
      titleGradient: { from: '#EEEDE6', to: '#EEEDE6' },
      overview:
        'Solo-founded and built Subcreation, a worldbuilding SaaS that lets fiction authors, TTRPG game masters, and independent creators organise lore, connect entities, navigate nested maps, and write with their world open beside them.',
      challenge:
        'Designing a flexible data model that can represent any world structure: custom entity types, typed relationships, hierarchical maps, and gated sharing, while keeping the editing experience fast and distraction-free.',
      approach:
        'Built on Next.js App Router with server actions for low-latency mutations; used Drizzle ORM over Neon Postgres for a strongly-typed data layer. Implemented a custom Tiptap wikilink extension that survives renames, React Flow for an explorable relationship graph with Dagre auto-layout, and a granular visibility system for reveal-as-you-go sharing with players or readers.',
      outcome:
        'Shipped a public alpha at subcreation.app with full-stack solo ownership end-to-end, from data model to deployment, validating the core loop of lore organisation, linking, mapping, and focused writing in one tool.',
    },
  },
  {
    id: 'project-2',
    ...
    repoUrl: '',
    tags: ['WordPress', 'HealthTech', 'E-commerce'],
    category: ['Full-Stack', 'Frontend'],
    accentColor: 'violet',
    accentHex: '#F8F3EA',
  ...
  },
  {
    ...
    repoUrl: '',
    tags: ['Next.js', 'React', 'MongoDB', 'Maps'],
  ...
  },
  {
    ...
    repoUrl: '',
    tags: ['Next.js', 'WordPress', 'Real Estate'],
    category: ['Full-Stack', 'Frontend'],
    accentColor: 'pink',
    accentHex: '#DEAFF8',
  ...
  },
  {
    ...
    repoUrl: '',
    tags: ['Next.js', 'React', 'MongoDB', 'SaaS', 'Dashboard'],
    category: ['Full-Stack', 'Data & Viz'],
    accentColor: 'cyan',
    accentHex: '#FCB22D',
  ...
  },
  {
    ...
    repoUrl: '',
    tags: ['Next.js', 'Web3', 'Accessibility'],
    category: ['Frontend'],
    accentColor: 'cyan',
    accentHex: '#7FD1FF',
